...
#[derive(Debug)]
pub struct CryptoNetProcessor {
    verbose: bool,
    processed_count: usize,
}

impl CryptoNetProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting CryptoNet processing");
    
    let mut processor = CryptoNetProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = CryptoNetProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = CryptoNetProcessor::new(false);
